...
from beerlin.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from beerlin.users.utils import save_picture
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next_page) if next_page else redirect(url_for('maps.map'))
        else:
